...
INSERT INTO LOS_DEL_SUR.PERMISOS(ROL_ID,FUNCION_ID)
	...
	WHERE R.ROL_NOMBRE='ADMINISTRATIVO' AND F.FUNCION_NOMBRE IN ('ABM CLIENTES','ABM PROVEEDORES','CONFECCION Y PUBLICACION OFERTA','FACTURACION A PROVEEDOR','LISTADO ESTADISTICO');

INSERT INTO LOS_DEL_SUR.PERMISOS(ROL_ID,FUNCION_ID)
	SELECT DISTINCT R.ROL_ID, F.FUNCION_ID FROM LOS_DEL_SUR.ROL R, LOS_DEL_SUR.FUNCIONALIDAD F
	WHERE R.ROL_NOMBRE='CLIENTE' AND F.FUNCION_NOMBRE IN ('CARGA DE CREDITO','COMPRAR OFERTA', 'LISTADO ESTADISTICO');

INSERT INTO LOS_DEL_SUR.PERMISOS(ROL_ID,FUNCION_ID)
	SELECT DISTINCT R.ROL_ID, F.FUNCION_ID FROM LOS_DEL_SUR.ROL R , LOS_DEL_SUR.FUNCIONALIDAD F
	WHERE R.ROL_NOMBRE='PROVEEDOR' AND F.FUNCION_NOMBRE IN('CONFECCION Y PUBLICACION OFERTA','ENTREGA/CONSUMO DE OFERTA', 'LISTADO ESTADISTICO');

INSERT INTO LOS_DEL_SUR.PERMISOS(ROL_ID,FUNCION_ID)
	SELECT DISTINCT R.ROL_ID, F.FUNCION_ID
	FROM LOS_DEL_SUR.ROL R , LOS_DEL_SUR.FUNCIONALIDAD F
	WHERE R.ROL_NOMBRE='Administrador General' AND F.FUNCION_NOMBRE IN ('ABM ROL','ABM CLIENTES','ABM PROVEEDORES','CARGA DE CREDITO','CONFECCION Y PUBLICACION OFERTA','COMPRAR OFERTA','ENTREGA/CONSUMO DE OFERTA','FACTURACION A PROVEEDOR','LISTADO ESTADISTICO');
